...
＝Ty→⊢ᵃ (𝐈𝐝Cong q₀ q₁ q₂) = 𝐈𝐝Cong (＝Tm→⊢ᵃ q₀) (＝Tm→⊢ᵃ q₁) (⊢Ty→⊢ᵃ q₂ )
＝Ty→⊢ᵃ (=Tm→Ty q) = ＝Tm→⊢ᵃ q
...
＝Tm→⊢ᵃ (𝛌Cong q₀ q₁ q₂ q₃) =
  𝛌Cong (＝Tm→⊢ᵃ q₀) q₁ (⊢Ty→⊢ᵃ q₂) (⊢Ty→⊢ᵃ q₃)
＝Tm→⊢ᵃ (∙Cong q₀ q₁ q₄ q₂ q₃) =
  ∙Cong (＝Tm→⊢ᵃ q₀) (＝Tm→⊢ᵃ q₁) q₄ (⊢Ty→⊢ᵃ q₂) (⊢Ty→⊢ᵃ q₃)
...
＝ᵃTy→⊢{Γ}{l} (∙Cong{B = B}{a}{a'}{b}{b'} q₀ q₁ q₂ q₃ q₄) e refl = =Tm→Ty
...
＝ᵃTy→⊢{Γ}{l} (𝚷Beta{A = A}{a}{B}{b} q₀ q₁ q₂ q₃ q₄) e refl = =Tm→Ty
