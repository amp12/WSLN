...
ok→ty ([] q q' _)   isInNew      = wkJg _ q q q'
ok→ty ([] q₀ q₁ q₃) (isInOld q₂) = wkJg _ q₀ (ok→ty q₃ q₂) q₁
...
𝐉Cong⁻ q₀ q₁ q₂ q₃ q₄ q₅ q₆ =
  𝐉Cong q₀ q₁ q₂ q₃ q₄ q₅ q₆ (⊢∶ty (⊢ty₁ q₁)) (π₁ (π₂ ([]⁻¹ (⊢ok q₀))))
...
𝐈𝐝Beta⁻ q₀ q₁ q₂ q₃ q₄ =
  𝐈𝐝Beta q₀ q₁ q₂ q₃ q₄ (⊢∶ty q₁) (π₁ (π₂ ([]⁻¹ (⊢ok q₀))))
